...
function AnimateElementVisibility(elem, mustShow, speed, displayStyle, StartStopCallback) {
  let elemInfos = [{
    elem: elem,
    mustShow: mustShow
  }]
  AnimateElementsVisibility(elemInfos, speed, displayStyle, StartStopCallback)
}
...
//   mustShow: bool
// }
function AnimateElementsVisibility(elemInfos, speed, displayStyle, StartStopCallback) {
  ...
  elemInfosToAnimate.forEach((elemInfo) => {
    ...
    elemInfo.elem.style.display = displayStyle
