...
function CreateZeroOrigin(jazil) {
  let items = [
    BuildItem({ set:g_source, name:'Pickaxe', count:3, priorWork:6 }),
    BuildItem({ set:g_source, name:'Book', count:4, priorWork:7 }),
    BuildItem({ set:g_source, name:'Book', count:5, priorWork:8 })
  ]
